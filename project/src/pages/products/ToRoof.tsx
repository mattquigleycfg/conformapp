...
const ToRoof: React.FC = () => {
  const [inputs, setInputs] = useState<ToRoofInputs>({
    width: 2400,
    length: 2400,
    height: 1200,
    roofType: 'Kliplok',
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-xl font-semibold text-gray-900">To Roof Calculator</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
          >
            <option value="Kliplok">Kliplok</option>
        ...
        <div>
          ...
          >
            ...
            <option value="Direct Fix">Direct Fix</option>
          </select>
        </div>
      </div>
